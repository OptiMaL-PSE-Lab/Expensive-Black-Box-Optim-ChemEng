...
ax1.legend()
ax1.set_yscale('log')
fig1.savefig('Quadratic_plots_Tight/Quadratic_Deterministic_Convergence_plot.svg', format = "svg")
...
fig2.savefig('Quadratic_plots_Tight/Quadratic_Deterministic_2Dspace_plot.svg', format = "svg")
...
ax2.set_xlim(bounds[0])
ax2.set_ylim(bounds[1])
fig1.savefig('Quadratic_plots_Tight/Quadratic_CUATROg_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_CUATROg_2Dspace_plot.svg', format = "svg")
...
ax2.set_xlim(bounds[0])
ax2.set_ylim(bounds[1])
fig1.savefig('Quadratic_plots_Tight/Quadratic_CUATROl_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_CUATROl_2Dspace_plot.svg', format = "svg")
...
ax2.set_ylim(bounds[1])
ax2.legend()
fig1.savefig('Quadratic_plots_Tight/Quadratic_simplex_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_simplex_2Dspace_plot.svg', format = "svg")
...
ax2.set_ylim(bounds[1])
ax2.legend()
fig1.savefig('Quadratic_plots_Tight/Quadratic_Nesterov_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_Nesterov_2Dspace_plot.svg', format = "svg")

## Change to x_best_So_far
fig1 = plt.figure()
ax1 = fig1.add_subplot()
ax2, fig2 = trust_fig(oracle, bounds)
for i in range(len(quadratic_SQSnobFit_list)):
...
ax2.set_ylim(bounds[1])
ax2.legend()
fig1.savefig('Quadratic_plots_Tight/Quadratic_SQSnobFit_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_SQSnobFit_2Dspace_plot.svg', format = "svg")

## Change to x_best_So_far
fig1 = plt.figure()
ax1 = fig1.add_subplot()
ax2, fig2 = trust_fig(oracle, bounds)
for i in range(len(quadratic_DIRECT_list)):
...
ax2.set_ylim(bounds[1])
ax2.legend()
fig1.savefig('Quadratic_plots_Tight/Quadratic_DIRECT_Convergence_plot.svg', format = "svg")
fig2.savefig('Quadratic_plots_Tight/Quadratic_DIRECT_2Dspace_plot.svg', format = "svg")
...
ax.set_yscale('log')
ax.set_xlim([0, 99])   
fig.savefig('Quadratic_publication_plots/PromisingMethodsTight.svg', format = "svg")
...
ax.set_yscale('log')
ax.set_xlim([0, 99])
fig.savefig('Quadratic_publication_plots/NotSoPromisingMethodsTight.svg', format = "svg")
