...
def objective(f, V_old, N_exp, nx, n_points, nu, theta, sigma, V, c1o, c2o,u):
    ...
    obj =-np.trace(vv1)#np.min(np.linalg.eig(vv1)[0])#np.log(np.linalg.det(vv1)+0.0001)#-## np.linalg.eig(vv)[0][0]#
