...
ContrLinRand_simplex_list = fix_starting_points(ContrLinRand_simplex_list, x0, initial_outputRand)
ContrLinRand_pybobyqa_list = fix_starting_points(ContrLinRand_pybobyqa_list, x0, initial_outputRand)
...
sol_BO = average_from_list(ContrLinRand_Bayes_list)
